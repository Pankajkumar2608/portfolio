    ...
    <section className="mb-32">
      ...
      <div className="flex flex-wrap gap-2 mb-10 fade-in fade-in-delay-2">
        {techStack.map((tech) => (
          <span
            key={tech.name}
            className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md bg-secondary/80 text-secondary-foreground border border-border/50 transition-colors hover:bg-accent cursor-default"
          >
            <span
